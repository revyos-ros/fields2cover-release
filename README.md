...
## fields2cover (humble) - 2.0.0-6

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Fri, 03 May 2024 22:12:34 -0000`
...
## fields2cover (rolling) - 2.0.0-8

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Fri, 03 May 2024 22:10:40 -0000`
...
## fields2cover (humble) - 2.0.0-5

The packages in the `fields2cover` repository were released into the `humble` distro by running `/usr/bin/bloom-release fields2cover --track humble --rosdistro humble` on `Thu, 02 May 2024 13:03:32 -0000`
...
## fields2cover (rolling) - 2.0.0-7

The packages in the `fields2cover` repository were released into the `rolling` distro by running `/usr/bin/bloom-release fields2cover --track rolling --rosdistro rolling` on `Thu, 02 May 2024 12:40:58 -0000`
